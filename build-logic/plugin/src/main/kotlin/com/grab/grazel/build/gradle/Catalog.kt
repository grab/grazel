...
internal fun VersionCatalog.version(reference: String): String? {
    return findVersion(reference).orElse(null)?.toString()
}

internal fun VersionCatalog.library(reference: String): String? {
    return findLibrary(reference).orElse(null)?.toString()
}