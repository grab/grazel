...
maven_install(
    ...
    override_targets = {
        ...
        "androidx.lifecycle:lifecycle-viewmodel-ktx": "@maven//:androidx_lifecycle_lifecycle_viewmodel_ktx",
        "androidx.profileinstaller:profileinstaller": "@maven//:androidx_profileinstaller_profileinstaller",
        "com.google.guava:listenablefuture": "@android_test_maven//:com_google_guava_listenablefuture",
        "org.jetbrains.kotlinx:kotlinx-coroutines-android": "@maven//:org_jetbrains_kotlinx_kotlinx_coroutines_android",
    },
    repositories = [
        "https://dl.google.com/dl/android/maven2/",
...
maven_install(
    ...
    override_targets = {
        "org.hamcrest:hamcrest-core": "@android_test_maven//:org_hamcrest_hamcrest_core",
    },
    repositories = [
        "https://dl.google.com/dl/android/maven2/",
        "https://repo.maven.apache.org/maven2/",
