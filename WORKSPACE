...
maven_install(
    ...
    override_targets = {
        "androidx.activity:activity": "@maven//:androidx_activity_activity",
        "androidx.activity:activity-compose": "@maven//:androidx_activity_activity_compose",
        "androidx.activity:activity-ktx": "@maven//:androidx_activity_activity_ktx",
        ...
        "androidx.autofill:autofill": "@maven//:androidx_autofill_autofill",
        "androidx.collection:collection": "@maven//:androidx_collection_collection",
        "androidx.compose.runtime:runtime": "@maven//:androidx_compose_runtime_runtime",
        "androidx.compose.runtime:runtime-saveable": "@maven//:androidx_compose_runtime_runtime_saveable",
        "androidx.compose.ui:ui": "@maven//:androidx_compose_ui_ui",
        "androidx.compose.ui:ui-geometry": "@maven//:androidx_compose_ui_ui_geometry",
        "androidx.compose.ui:ui-graphics": "@maven//:androidx_compose_ui_ui_graphics",
        "androidx.compose.ui:ui-text": "@maven//:androidx_compose_ui_ui_text",
        "androidx.compose.ui:ui-unit": "@maven//:androidx_compose_ui_ui_unit",
        "androidx.compose.ui:ui-util": "@maven//:androidx_compose_ui_ui_util",
        ...
        "androidx.customview:customview-poolingcontainer": "@maven//:androidx_customview_customview_poolingcontainer",
        "androidx.databinding:databinding-ktx": "@maven//:androidx_databinding_databinding_ktx",
        "androidx.emoji2:emoji2": "@maven//:androidx_emoji2_emoji2",
        "androidx.lifecycle:lifecycle-common": "@maven//:androidx_lifecycle_lifecycle_common",
        "androidx.lifecycle:lifecycle-common-jvm": "@maven//:androidx_lifecycle_lifecycle_common_jvm",
        ...
        "androidx.profileinstaller:profileinstaller": "@maven//:androidx_profileinstaller_profileinstaller",
...
maven_install(
    ...
    override_targets = {
        ...
        "androidx.interpolator:interpolator": "@maven//:androidx_interpolator_interpolator",
        "androidx.lifecycle:lifecycle-common": "@maven//:androidx_lifecycle_lifecycle_common",
        "androidx.lifecycle:lifecycle-common-jvm": "@maven//:androidx_lifecycle_lifecycle_common_jvm",
        "androidx.lifecycle:lifecycle-livedata": "@maven//:androidx_lifecycle_lifecycle_livedata",
        "androidx.lifecycle:lifecycle-livedata-core": "@maven//:androidx_lifecycle_lifecycle_livedata_core",
        ...
        "androidx.lifecycle:lifecycle-runtime": "@maven//:androidx_lifecycle_lifecycle_runtime",
        "androidx.lifecycle:lifecycle-runtime-android": "@maven//:androidx_lifecycle_lifecycle_runtime_android",
        "androidx.lifecycle:lifecycle-runtime-ktx": "@maven//:androidx_lifecycle_lifecycle_runtime_ktx",
        "androidx.lifecycle:lifecycle-runtime-ktx-android": "@maven//:androidx_lifecycle_lifecycle_runtime_ktx_android",
        "androidx.lifecycle:lifecycle-viewmodel": "@maven//:androidx_lifecycle_lifecycle_viewmodel",
        "androidx.lifecycle:lifecycle-viewmodel-android": "@maven//:androidx_lifecycle_lifecycle_viewmodel_android",
        "androidx.lifecycle:lifecycle-viewmodel-ktx": "@maven//:androidx_lifecycle_lifecycle_viewmodel_ktx",
        "androidx.profileinstaller:profileinstaller": "@maven//:androidx_profileinstaller_profileinstaller",
        "androidx.startup:startup-runtime": "@maven//:androidx_startup_startup_runtime",
        "androidx.tracing:tracing": "@maven//:androidx_tracing_tracing",
