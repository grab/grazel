...
kotlin_repositories(compiler_release = KOTLINC_RELEASE, ksp_compiler_release = KSP_COMPILER_RELEASE)
register_toolchains("//:kotlin_toolchain")

http_archive(name = "rules_java",  urls = [
    "https://github.com/bazelbuild/rules_java/releases/download/7.6.1/rules_java-7.6.1.tar.gz",
  ],  sha256 = "f8ae9ed3887df02f40de9f4f7ac3873e6dd7a471f9cddf63952538b94b59aeb3",  patches = [
    "//patches/rules_java:turbine_worker.patch",
  ],  patch_args = [
    "-p1",
  ])
